...
にくきゅう丸0.103は、かな・英数字などに Mochiy Pop One、一般漢字に
`Zen Maru Gothic Black` の輪郭を使います。Zenは初めに不足記号の補完元として
導入し、コンセプト比較後に一般漢字の基準にも採用しました。Mochiyに存在しない
JIS X 0208 非漢字や CP932 の記号の補完にも引き続き使用します。
...
追加するため、6,355 漢字の再生成を避けた検証・再ビルドに利用できます。
