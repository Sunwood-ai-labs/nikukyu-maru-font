...
digest=hashlib.sha256((ROOT/'outputs/latin-review/NikukyuMaru-0.104.woff2').read_bytes()).hexdigest()
...
@font-face{font-family:Niku;src:url('NikukyuMaru-0.104.woff2?v=DIGEST')}
